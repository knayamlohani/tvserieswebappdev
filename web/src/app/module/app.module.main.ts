...
import {SearchComponent} from "../component/search/app.component.search";
import {FormsModule} from '@angular/forms';
import {AppHeaderComponent} from "../component/header/app.component.header";
import {LoggerService} from "../service/app.service.logger";
import {Routes, RouterModule} from "@angular/router";
import {TVSeriesComponent} from "../component/tv_series/app.component.tv_series";
import {DataService} from "../service/app.service.data";
import {SeasonComponent} from "../component/season/app.component.season";
import {EpisodeComponent} from "../component/episode/app.component.episode";
import {SeasonService} from "../service/app.service.season";
import {CastMemberComponent} from "../component/cast_member/app.component.cast_member";
